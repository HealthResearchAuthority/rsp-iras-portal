...
{
    public async Task<IActionResult> Index(int pageNumber = 1, int pageSize = 20, IList<string>? selectedModificationIds = null)
    {
        ...
        var result = await applicationsService.GetModifications(modQuery, pageNumber, pageSize);
