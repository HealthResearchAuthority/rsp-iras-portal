...
public class ViewHelper : IViewHelper
{
    ...
    public async Task<byte[]> GeneratePdf(string html, string footerText = "")
    {
            ...
            '>
                ...
                '>
                    <div style='display:flex; align-items:center; gap:15px;'>
                        <svg focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 324 60" height="30" width="162" aria-label="GOV.UK">
                        <title>GOV.UK</title>
                            <g>
                        ...
                        <span style='font-size:28px;font-weight:400;position:relative;top:4px'>
                            Plan and manage health and care research
                        </span>
                    </div>
                </div>
            </div>
    ...
    private static string InjectCss(string html)
    {
        ...
        return $"""
            ...
            <body class="govuk-template__body govuk-template--rebranded">
                {html}
            </body>
            </html>
            """;
