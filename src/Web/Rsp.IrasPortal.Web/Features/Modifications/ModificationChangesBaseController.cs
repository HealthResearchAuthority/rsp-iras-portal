...
) : Controller
{
    ...
    protected async Task SaveModificationAnswers(Guid projectModificationChangeId, string projectRecordId, List<QuestionViewModel> questions)
    {
        // save the responses
    ...
    protected List<QuestionViewModel> GetQuestionsFromSession(QuestionnaireViewModel model)
    {
        var questionsData = TempData.Peek($"{ProjectModification.Questionnaire}:{model.CurrentStage}") as string;
    ...
    /// </remarks>
    protected async Task<NavigationDto> SetStage(string sectionId, IEnumerable<QuestionViewModel> questions)
    {
    ...
    protected static void UpdateWithAnswers(IEnumerable<RespondentAnswerDto> respondentAnswers, List<QuestionViewModel> questionAnswers)
    {
    ...
    public async Task<IActionResult> ReviewChanges(string projectRecordId)
    {
    ...
    public async Task<IActionResult> ConfirmModificationChanges()
    {
        ...
        return RedirectToRoute("pov:postapproval", new { projectRecordId = projectRecordId });
    }
}