    ...
    private static readonly Dictionary<string, List<string>> _rolePermissionMap = new()
    {
        ...
        },
        {
            Roles.SystemAdministrator, new List<string>
            {
                ...
                Sponsor.Workspace_Access,
                Approvals.Workspace_Access,
                SystemAdministration.Workspace_Access,
                CAGMembers.Workspace_Access,
                MemberManagement.Workspace_Access,
                CAT.Workspace_Access,
                RECMembers.Workspace_Access,
                TechnicalAssurance.Workspace_Access,
                TechnicalAssuranceReviewers.Workspace_Access
            }
        }
    };
