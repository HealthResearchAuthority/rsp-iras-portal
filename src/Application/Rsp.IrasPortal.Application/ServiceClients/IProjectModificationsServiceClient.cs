...
public interface IProjectModificationsServiceClient
{
    ...
    public Task<IApiResponse> UpdateModificationStatus(string projectRecordId, Guid modificationId, string status, string? revisionDescription = null, string? reasonNotApproved = null, string? revisionResponseByApplicant = null);
