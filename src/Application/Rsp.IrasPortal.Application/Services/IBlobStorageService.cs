...
public interface IBlobStorageService
{
    ...
    Task<(byte[] FileBytes, string FileName)> DownloadFolderAsZipAsync(BlobServiceClient blobServiceClient, string containerName, string folderName, string saveAsFileName);
}