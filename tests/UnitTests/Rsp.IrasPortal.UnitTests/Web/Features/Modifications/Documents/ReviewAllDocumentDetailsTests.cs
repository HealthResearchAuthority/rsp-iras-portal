...
public class ReviewAllDocumentDetailsTests : TestServiceBase<DocumentsController>
{
    ...
    [Fact]
    public async Task ReviewAllDocumentDetails_WhenStatusIsRFI_ShouldRedirectToModificationDetails()
    {
        // Arrange
        var docId = Guid.NewGuid();
        ...
        Sut.TempData = new TempDataDictionary(new DefaultHttpContext(), Mock.Of<ITempDataProvider>())
        {
            ...
            [TempDataKeys.RevisionSponsorOrganisationUserId] = sponsorUserId,
            [TempDataKeys.RevisionRtsId] = rtsId,
            [TempDataKeys.ProjectModification.ProjectModificationStatus] = ModificationStatus.RequestForInformation,
            [TempDataKeys.IrasId] = "IRAS-123",
            [TempDataKeys.ShortProjectTitle] = "Short title"
        };
    ...
    [Fact]
    public async Task ReviewAllDocumentDetails_WhenStatusIsResponseReviseAndAuthorise_ShouldRedirectToRfiResponses()
    {
        // Arrange
        var docId = Guid.NewGuid();
        ...
        Sut.TempData = new TempDataDictionary(new DefaultHttpContext(), Mock.Of<ITempDataProvider>())
        {
            ...
            [TempDataKeys.RevisionSponsorOrganisationUserId] = sponsorUserId,
            [TempDataKeys.RevisionRtsId] = rtsId,
            [TempDataKeys.ProjectModification.ProjectModificationStatus] = ModificationStatus.ResponseReviseAndAuthorise,
            [TempDataKeys.IrasId] = "IRAS-123",
            [TempDataKeys.ShortProjectTitle] = "Short title"
        };
    ...
    [Fact]
    public async Task ReviewAllDocumentDetails_WhenStatus_ResponseRequestRevision_ShouldRedirectToRfiResponses()
    {
        // Arrange
        var docId = Guid.NewGuid();
