...
public class AuthorisationsModificationsControllerTests : TestServiceBase<TestAuthorisationsModificationsController>
{
    ...
    [Fact]
    public async Task ProjectRestartUpdate_Returns_ConfirmationView()
    {
        // Arrange
        var authoriseOutcomeViewModel = SetupAuthoriseOutcomeViewModel();
        ...
        {
            [TempDataKeys.ProjectModification.SpecificAreaOfChangeText] = "0c715e3f-22bd-47fb-9a37-710e0248b761",
        };
        Sut.TempData = temp;
        Mocker
            .GetMock<IProjectModificationsService>()
