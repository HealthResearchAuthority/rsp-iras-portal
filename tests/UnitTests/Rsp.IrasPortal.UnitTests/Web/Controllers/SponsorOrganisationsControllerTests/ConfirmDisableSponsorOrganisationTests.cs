...
public class ConfirmDisableSponsorOrganisationTests : TestServiceBase<SponsorOrganisationsController>
{
    private readonly DefaultHttpContext _http;

    public ConfirmDisableSponsorOrganisationTests()
    {
    ...
    [Theory]
    [AutoData]
    public async Task ConfirmDisableSponsorOrganisation_ReturnsToView(
        SponsorOrganisationUserDto sponsorOrganisationUserDto)
    {
        ...
        Mocker.GetMock<ISponsorOrganisationService>()
            .Setup(s => s.DisableSponsorOrganisation(rtsId))
        ...
        // Act
        var result = await Sut.ConfirmDisableSponsorOrganisation(rtsId);
