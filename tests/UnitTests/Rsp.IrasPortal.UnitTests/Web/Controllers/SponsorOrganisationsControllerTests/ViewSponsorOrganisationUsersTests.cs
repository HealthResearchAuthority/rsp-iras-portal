...
public class ViewSponsorOrganisationUsersTests : TestServiceBase<SponsorOrganisationsController>
{
    ...
    [Fact]
    public async Task ViewSponsorOrganisationUsers_ShouldReturnView_WithMappedModel_WhenBothServicesSucceed_Asc_GivenName()
    {
        // Arrange
    ...
    [Fact]
    public async Task ViewSponsorOrganisationUsers_ShouldReturnView_WithMappedModel_WhenBothServicesSucceed_Asc_Email()
    {
        // Arrange
        const string rtsId = "87765";
        const string orgName = "Acme Research Ltd";
    ...
    [Fact]
    public async Task
        ViewSponsorOrganisationUsers_ShouldReturnView_WithMappedModel_WhenBothServicesSucceed_Asc_CurrentLogin()
    {
        // Arrange
        const string rtsId = "87765";
        const string orgName = "Acme Research Ltd";
    ...
    [Fact]
    public async Task ViewSponsorOrganisationUsers_ShouldReturnView_WithMappedModel_WhenBothServicesSucceed_Asc_Status()
    {
        // Arrange
        const string rtsId = "87765";
        const string orgName = "Acme Research Ltd";
    ...
    [Fact]
    public async Task ViewSponsorOrganisationUsers_ShouldReturnView_WithMappedModel_WhenBothServicesSucceed_Desc_GivenName()
    {
        // Arrange
        const string rtsId = "87765";
        const string orgName = "Acme Research Ltd";
        ...
        // Act
        var result = await Sut.ViewSponsorOrganisationUsers(rtsId, null, 1, 20, "GivenName", "desc");
    ...
    [Fact]
    public async Task ViewSponsorOrganisationUsers_ShouldReturnView_WithMappedModel_WhenBothServicesSucceed_Desc_Email()
    {
        // Arrange
        const string rtsId = "87765";
        const string orgName = "Acme Research Ltd";
    ...
    [Fact]
    public async Task
        ViewSponsorOrganisationUsers_ShouldReturnView_WithMappedModel_WhenBothServicesSucceed_Desc_CurrentLogin()
    {
        // Arrange
        const string rtsId = "87765";
        const string orgName = "Acme Research Ltd";
    ...
    [Fact]
    public async Task ViewSponsorOrganisationUsers_ShouldReturnView_WithMappedModel_WhenBothServicesSucceed_Desc_Status()
    {
        // Arrange
        const string rtsId = "87765";
        const string orgName = "Acme Research Ltd";
