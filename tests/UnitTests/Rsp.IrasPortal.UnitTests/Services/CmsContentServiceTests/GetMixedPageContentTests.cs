...
public class GetMixedPageContentTests : TestServiceBase<CmsContentService>
{
    ...
    [Fact]
    public async Task GetMixedPageContentByUrl_ShouldReturnResponse_WhenPageIsFound()
    {
        // Arrange
    ...
    [Fact]
    public async Task GetMixedPageContentByUrl_ShouldReturnResponseFromCache_WhenPageIsFoundInCache()
    {
        // Arrange
